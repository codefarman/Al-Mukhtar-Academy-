...
//         <ul className="flex gap-20 text-lg text-gray-700  items-center">
//           <li><Link to="/" className="hover:text-green-600">Home</Link></li>
//           <li><Link to="/books" className="hover:text-green-600">Books</Link></li>
//           <li><Link to="/about" className="hover:text-green-600">About</Link></li>
//           <li><Link to="/admin/login" className="hover:text-green-600">Admin</Link></li>
//         </ul>
//         <div>
